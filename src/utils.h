...
public:
	...
	*/
	...
	//initiate by transformation matrix(SE3)
	...
	CameraPose differencing(CameraPose pose2, CameraPose pose1) { //pose2 - pose1
		CameraPose pose;
		pose.intrinsics = pose2.intrinsics;
		pose.R = pose2.R * pose1.R.reverse();
		pose.t = pose2.t - pose2.R*pose1.t;
		pose.refreshByARt();
		return pose;
	}
	/*
...
public:
	...
	u32* getImage() const { return image; }
	CameraPose getPose() const { return pose; }
